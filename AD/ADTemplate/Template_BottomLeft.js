...
function BottomLeftZoneAD(_id) {
  ...
  /* Define Functions */
  this.AddAD       = BottomLeftZoneAD_AddAD;
  this.GetShowAD   = BottomLeftZoneAD_GetShowAD;
  this.Show        = BottomLeftZoneAD_Show;
  this.Move        = BottomLeftZoneAD_Move;

}

function BottomLeftZoneAD_AddAD(_AD) {
  this.AllAD[this.AllAD.length] = _AD;
}

function BottomLeftZoneAD_GetShowAD() {
  if (this.ShowType > 1) {
...
function BottomLeftZoneAD_Show() {
  if (!this.AllAD) {
    return;
  } else {
    this.GetShowAD();
  ...
  this.DivName = "BottomLeftZoneAD_Div" + this.ZoneID;
...
function BottomLeftZoneAD_Move() {
  if (window.innerWidth) {
    this.Div.style.top=window.innerHeight-this.Top;
  } else {
    this.Div.style.top=document.documentElement.scrollTop+document.documentElement.offsetHeight-this.Top;
  }
  this.Div.style.left=this.Left;
  this.Div.style.display = '';
  //setTimeout(this.ID+".Move()",this.Delay)
}
