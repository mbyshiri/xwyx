...
Sub Add()
    Response.Write "<form action='Admin_ArticleJS.asp' method='post' name='myform' id='myform'>"
    ...
    Response.Write "          <option value='4'>智能多列式</option>"
    Response.Write "          <option value='5'>DIV输出</option>"
    Response.Write "        </select>"
    Response.Write "      </td>"
    Response.Write "    </tr>"
    Response.Write "    <tr class='tdbg'>"
    Response.Write "      <td height='25' align='right'><strong>作者：</strong></td>"
    Response.Write "      <td height='25'><input name='Author' type='text' value='' size='10' maxlength='20'> <font color='#FF0000'>如果不为空，则只显示指定作者的" & ChannelShortName & "，用于个人文集。</font></td>"
    Response.Write "    </tr>"
    Response.Write "    <tr class='tdbg'>"
    Response.Write "      <td height='25' align='right'><strong>" & ChannelShortName & "数目：</strong></td>"
    Response.Write "      <td height='25'><input name='ArticleNum' type='text' value='10' size='5' maxlength='3'> <font color='#FF0000'>*</font></td>"
    Response.Write "    </tr>"
    Response.Write "    <tr class='tdbg'>"
    ...
    Response.Write "    </tr>"
    Response.Write "    <tr class='tdbg'>"
    Response.Write "      <td height='25' align='right'><strong>" & ChannelShortName & "标题字符数：</strong></td>"
    Response.Write "      <td height='25'><input name='TitleLen' type='text' id='TitleLen' value='30' size='5' maxlength='3'>&nbsp;&nbsp;&nbsp;&nbsp;<font color='#FF0000'>如果为0，则显示完整标题。字母算一个字符，汉字算两个字符。</font></td>"
    Response.Write "    </tr>"
    Response.Write "    <tr class='tdbg'>"
    Response.Write "      <td height='25' align='right'><strong>" & ChannelShortName & "内容字符数：</strong></td>"
    Response.Write "      <td height='25'><input name='ContentLen' type='text' id='ContentLen' value='0' size='5' maxlength='3'>&nbsp;&nbsp;&nbsp;&nbsp;<font color='#FF0000'>如果大于0，则在" & ChannelShortName & "标题下方显示指定字数的" & ChannelShortName & "内容</font></td>"
    Response.Write "    </tr>"
    Response.Write "    <tr class='tdbg'>"
    ...
    Response.Write "          <td><input name='ShowIncludePic' type='checkbox' id='ShowIncludePic' value='1' checked>“图文”标志</td>"
    ...
    Response.Write "          <td><input name='ShowCommentLink' type='checkbox' id='ShowCommentLink' value='1'>显示评论链接</td>"
...
Sub Modify()
    ...
    Response.Write "          <option " & OptionValue(PE_CLng(JsConfig(0)), 4) & ">智能多列式</option>"
    Response.Write "          <option " & OptionValue(PE_CLng(JsConfig(0)), 5) & ">DIV输出</option>"
    Response.Write "        </select>"
    Response.Write "      </td>"
    Response.Write "    </tr>"
    Response.Write "    <tr class='tdbg'>"
    Response.Write "      <td height='25' align='right'><strong>作者：</strong></td>"
    Response.Write "      <td height='25'><input name='Author' type='text' value='" & ZeroToEmpty(JsConfig(23)) & "' size='10' maxlength='20'> <font color='#FF0000'>如果不为空，则只显示指定作者的" & ChannelShortName & "，用于个人文集。</font></td>"
    Response.Write "    </tr>"
    Response.Write "    <tr class='tdbg'>"
    Response.Write "      <td height='25' align='right'><strong>" & ChannelShortName & "数目：</strong></td>"
    Response.Write "      <td height='25'><input name='ArticleNum' type='text' value='" & JsConfig(1) & "' size='5' maxlength='3'> <font color='#FF0000'>*</font></td>"
    Response.Write "    </tr>"
    Response.Write "    <tr class='tdbg'>"
    Response.Write "      <td height='25' align='right'><strong>所属栏目：</strong></td>"
    Response.Write "      <td height='25'>"
    ...
    Response.Write "      <td height='25'>"
    Response.Write "        <select name='ShowPropertyType' id='ShowPropertyType'>"
    Response.Write "          <option " & OptionValue(PE_CLng(JsConfig(22)), 0) & ">不显示</option>"
    Response.Write "          <option " & OptionValue(PE_CLng(JsConfig(22)), 2) & ">符号</option>"
    Response.Write "          <option " & OptionValue(PE_CLng(JsConfig(22)), 1) & ">小图片（样式1）</option>"
    Response.Write "          <option " & OptionValue(PE_CLng(JsConfig(22)), 3) & ">小图片（样式2）</option>"
    Response.Write "          <option " & OptionValue(PE_CLng(JsConfig(22)), 4) & ">小图片（样式3）</option>"
    Response.Write "          <option " & OptionValue(PE_CLng(JsConfig(22)), 5) & ">小图片（样式4）</option>"
    Response.Write "          <option " & OptionValue(PE_CLng(JsConfig(22)), 6) & ">小图片（样式5）</option>"
    Response.Write "        </select>"
    Response.Write "      </td>"
    Response.Write "    </tr>"
    Response.Write "    <tr class='tdbg'>"
    Response.Write "      <td height='25' align='right'><strong>" & ChannelShortName & "标题字符数：</strong></td>"
    Response.Write "      <td height='25'><input name='TitleLen' type='text' id='TitleLen' value='" & JsConfig(8) & "' size='5' maxlength='3'>&nbsp;&nbsp;&nbsp;&nbsp;<font color='#FF0000'>如果为0，则显示完整标题。字母算一个字符，汉字算两个字符。</font></td>"
    Response.Write "    </tr>"
    Response.Write "    <tr class='tdbg'>"
    Response.Write "      <td height='25' align='right'><strong>" & ChannelShortName & "内容字符数：</strong></td>"
    Response.Write "      <td height='25'><input name='ContentLen' type='text' id='ContentLen' value='" & JsConfig(9) & "' size='5' maxlength='3'>&nbsp;&nbsp;&nbsp;&nbsp;<font color='#FF0000'>如果大于0，则在" & ChannelShortName & "标题下方显示指定字数的" & ChannelShortName & "内容</font></td>"
    Response.Write "    </tr>"
    Response.Write "    <tr class='tdbg'>"
    Response.Write "      <td height='50' align='right'><strong>显示内容：</strong></td>"
    Response.Write "      <td height='50'><table width='100%' border='0' cellpadding='1' cellspacing='2'>"
    ...
    Response.Write "          <td><input name='ShowIncludePic' type='checkbox' id='ShowIncludePic' " & RadioValue(PE_CLng(JsConfig(11)), 1) & ">“图文”标志</td>"
    Response.Write "          <td><input name='ShowAuthor' type='checkbox' id='ShowAuthor' " & RadioValue(PE_CLng(JsConfig(12)), 1) & ">作者</td>"
    Response.Write "          <td>更新时间"
    Response.Write "            <select name='ShowDateType' id='ShowDateType'>"
    Response.Write "              <option " & OptionValue(PE_CLng(JsConfig(13)), 0) & ">不显示</option>"
    Response.Write "              <option " & OptionValue(PE_CLng(JsConfig(13)), 1) & ">年月日</option>"
    Response.Write "              <option " & OptionValue(PE_CLng(JsConfig(13)), 2) & ">月日</option>"
    Response.Write "              <option " & OptionValue(PE_CLng(JsConfig(13)), 3) & ">月-日</option>"
    Response.Write "            </select>"
    Response.Write "          </td>"
    Response.Write "          <td><input name='ShowHits' type='checkbox' id='ShowHits' " & RadioValue(PE_CLng(JsConfig(14)), 1) & ">点击次数</td>"
    Response.Write "        </tr>"
    Response.Write "        <tr>"
    Response.Write "          <td><input name='ShowHotSign' type='checkbox' id='ShowHotSign' " & RadioValue(PE_CLng(JsConfig(15)), 1) & ">热门" & ChannelShortName & "标志</td>"
    Response.Write "          <td><input name='ShowNewSign' type='checkbox' id='ShowNewSign' " & RadioValue(PE_CLng(JsConfig(16)), 1) & ">最新" & ChannelShortName & "标志</td>"
    Response.Write "          <td><input name='ShowTips' type='checkbox' id='ShowTips' " & RadioValue(PE_CLng(JsConfig(17)), 1) & ">显示提示信息</td>"
    Response.Write "          <td><input name='ShowCommentLink' type='checkbox' id='ShowCommentLink' " & RadioValue(PE_CLng(JsConfig(18)), 1) & ">显示评论链接</td>"
    Response.Write "          <td> </td>"
    Response.Write "        </tr>"
    Response.Write "      </table></td>"
    Response.Write "    </tr>"
    ...
    Response.Write "      <td height='25'>"
    Response.Write "        <select name='OpenType' id='OpenType'>"
    Response.Write "          <option " & OptionValue(PE_CLng(JsConfig(19)), 0) & ">在原窗口打开</option>"
    Response.Write "          <option " & OptionValue(PE_CLng(JsConfig(19)), 1) & ">在新窗口打开</option>"
    Response.Write "        </select>"
    Response.Write "      </td>"
    Response.Write "    </tr>"
    Response.Write "    <tr class='tdbg'>"
    ...
    Response.Write "      <td height='25'>"
    Response.Write "        <select name='UrlType' id='OpenType'>"
    Response.Write "          <option " & OptionValue(PE_CLng(JsConfig(21)), 0) & ">使用相对路径</option>"
    Response.Write "          <option " & OptionValue(PE_CLng(JsConfig(21)), 1) & ">使用包含完整网址的绝对路径</option>"
    Response.Write "        </select>"
    Response.Write "      </td>"
    Response.Write "    </tr>"
    Response.Write "    <tr class='tdbg'>"
    Response.Write "      <td height='25' align='right'><strong>每行标题列数：</strong></td>"
    Response.Write "      <td height='25'><input name='Cols' type='text' value='" & PE_CLng(JsConfig(24)) & "' size='5' maxlength='3'> <font color='#FF0000'>每行显示标题的列数</font></td>"
    Response.Write "    </tr>"
    Response.Write "    <tr class='tdbg'>"
    Response.Write "      <td height='25' align='right'><strong>CSS风格类名：</strong></td>"
    Response.Write "      <td height='25'><input name='CssNameA' type='text' value='" & ZeroToEmpty(JsConfig(25)) & "' size='10' maxlength='20'> <font color='#FF0000'>列表中文字链接调用的CSS类名</font></td>"
    Response.Write "    </tr>"
    Response.Write "    <tr class='tdbg'>"
    Response.Write "      <td height='25' align='right'><strong>风格样式1：</strong></td>"
    Response.Write "      <td height='25'><input name='CssName1' type='text' value='" & ZeroToEmpty(JsConfig(26)) & "' size='10' maxlength='20'> <font color='#FF0000'>列表中奇数行的CSS效果的类名</font></td>"
    Response.Write "    </tr>"
    Response.Write "    <tr class='tdbg'>"
    Response.Write "      <td height='25' align='right'><strong>风格样式2：</strong></td>"
    Response.Write "      <td height='25'><input name='CssName2' type='text' value='" & ZeroToEmpty(JsConfig(27)) & "' size='10' maxlength='20'> <font color='#FF0000'>列表中偶数行的CSS效果的类名</font></td>"
    Response.Write "    </tr>"
...
Sub AddPic()
    ...
    Response.Write "    <tr class='tdbg'>"
    Response.Write "      <td height='25' align='right'><strong>" & ChannelShortName & "数目：</strong></td>"
    Response.Write "      <td height='25'><input name='ArticleNum' type='text' value='4' size='5' maxlength='3'> <font color='#FF0000'>*</font></td>"
    Response.Write "    </tr>"
    Response.Write "    <tr class='tdbg'>"
    Response.Write "      <td height='25' align='right'><strong>" & ChannelShortName & "属性：</strong></td>"
    Response.Write "      <td height='25'>"
    ...
    Response.Write "      <td height='25' align='right'><strong>显示样式：</strong></td>"
    Response.Write "      <td height='25'>"
    Response.Write "        <input name='ShowType' type='radio' value='1' checked> 图片+标题+内容简介：上下排列<br>"
    Response.Write "        <input name='ShowType' type='radio' value='2'> （图片+标题：上下排列）+内容简介：左右排列<br>"
    Response.Write "        <input name='ShowType' type='radio' value='3'> 图片+（标题+内容简介：上下排列）：左右排列"
    Response.Write "      </td>"
    Response.Write "    </tr>"
    Response.Write "    <tr class='tdbg'>"
    ...
    Response.Write "    <tr class='tdbg'>"
    Response.Write "      <td height='25' align='right'><strong>" & ChannelShortName & "标题字符数：</strong></td>"
    Response.Write "      <td height='25'><input name='TitleLen' type='text' id='TitleLen' value='20' size='5' maxlength='3'> &nbsp;&nbsp;&nbsp;&nbsp;<font color='#FF0000'>若为0，则不显示标题；若为-1，则显示完整标题。字母算一个字符，汉字算两个字符。</font></td>"
    Response.Write "    </tr>"
    Response.Write "    <tr class='tdbg'>"
    Response.Write "      <td height='25' align='right'><strong>" & ChannelShortName & "内容字符数：</strong></td>"
    Response.Write "      <td height='25'><input name='ContentLen' type='text' id='ContentLen' value='0' size='5' maxlength='3'> &nbsp;&nbsp;&nbsp;&nbsp;<font color='#FF0000'>如果大于0，则显示指定字数的" & ChannelShortName & "内容</font></td>"
    Response.Write "    </tr>"
    Response.Write "    <tr class='tdbg'>"
...
Sub ModifyPic()
    ...
    Response.Write "    <tr class='tdbg'>"
    Response.Write "      <td height='25' align='right'><strong>所属专题：</strong></td>"
    Response.Write "      <td height='25' ><select name='SpecialID' id='SpecialID'><option value=''>不属于任何专题</option>" & GetSpecial_Option(PE_CLng(JsConfig(14))) & "</select></td>"
    Response.Write "    </tr>"
    Response.Write "    <tr class='tdbg'>"
    Response.Write "      <td height='25' align='right'><strong>" & ChannelShortName & "数目：</strong></td>"
    Response.Write "      <td height='25'><input name='ArticleNum' type='text' value='" & JsConfig(2) & "' size='5' maxlength='3'> <font color='#FF0000'>*</font></td>"
    Response.Write "    </tr>"
    Response.Write "    <tr class='tdbg'>"
    Response.Write "      <td height='25' align='right'><strong>" & ChannelShortName & "属性：</strong></td>"
    Response.Write "      <td height='25'>"
    ...
    Response.Write "      <td height='25' align='right'><strong>显示样式：</strong></td>"
    Response.Write "      <td height='25'>"
    Response.Write "        <input name='ShowType' type='radio' " & RadioValue(PE_CLng(JsConfig(7)), 1) & ">图片+标题+内容简介：上下排列<br>"
    Response.Write "        <input name='ShowType' type='radio' " & RadioValue(PE_CLng(JsConfig(7)), 2) & ">（图片+标题：上下排列）+内容简介：左右排列<br>"
    Response.Write "        <input name='ShowType' type='radio' " & RadioValue(PE_CLng(JsConfig(7)), 3) & ">图片+（标题+内容简介：上下排列）：左右排列"
    Response.Write "      </td>"
    Response.Write "    </tr>"
    Response.Write "    <tr class='tdbg'>"
    Response.Write "      <td height='25' align='right'><b>首页图片设置：</b></td>"
    ...
    Response.Write "    <tr class='tdbg'>"
    Response.Write "      <td height='25' align='right'><strong>" & ChannelShortName & "标题字符数：</strong></td>"
    Response.Write "      <td height='25'><input name='TitleLen' type='text' id='TitleLen' value='" & JsConfig(10) & "' size='5' maxlength='3'> &nbsp;&nbsp;&nbsp;&nbsp;<font color='#FF0000'>若为0，则不显示标题；若为-1，则显示完整标题。字母算一个字符，汉字算两个字符。</font></td>"
    Response.Write "    </tr>"
    Response.Write "    <tr class='tdbg'>"
    Response.Write "      <td height='25' align='right'><strong>" & ChannelShortName & "内容字符数：</strong></td>"
    Response.Write "      <td height='25'><input name='ContentLen' type='text' id='ContentLen' value='" & JsConfig(11) & "' size='5' maxlength='3'> &nbsp;&nbsp;&nbsp;&nbsp;<font color='#FF0000'>如果大于0，则显示指定字数的" & ChannelShortName & "内容</font></td>"
    Response.Write "    </tr>"
    Response.Write "    <tr class='tdbg'>"
    Response.Write "      <td height='25' align='right'><strong>显示内容：</strong></td>"
    ...
    Response.Write "      <td height='25'>"
    Response.Write "        <select name='UrlType' id='OpenType'>"
    Response.Write "          <option " & OptionValue(PE_CLng(JsConfig(15)), 0) & ">使用相对路径</option>"
    Response.Write "          <option " & OptionValue(PE_CLng(JsConfig(15)), 1) & ">使用包含完整网址的绝对路径</option>"
    Response.Write "        </select>"
    Response.Write "      </td>"
    Response.Write "    </tr>"
    Response.Write "    <tr class='tdbg'>"
...
Sub SaveJS_List()
    ...
    Dim ShowType, ArticleNum, ClassID, SpecialID, IncludeChild, IsHot, IsElite, DateNum, OrderType, TitleLen, ContentLen
    Dim ShowClassName, ShowAuthor, ShowDateType, ShowHits, ShowHotSign
    Dim ShowNewSign, ShowTips, ShowIncludePic, ShowCommentLink, OpenType, UrlType, ShowPropertyType
    ...
    ShowIncludePic = PE_CLng(Trim(Request("ShowIncludePic")))
    ...
    ShowCommentLink = PE_CLng(Trim(Request("ShowCommentLink")))
    ...
    Config = ShowType & "|" & ArticleNum & "|" & ClassID & "|" & IncludeChild & "|" & IsHot & "|" & IsElite & "|" & DateNum & "|" & OrderType & "|" & TitleLen & "|" & ContentLen & "|" & ShowClassName & "|" & ShowIncludePic & "|" & ShowAuthor & "|" & ShowDateType & "|" & ShowHits & "|" & ShowHotSign & "|" & ShowNewSign & "|" & ShowTips & "|" & ShowCommentLink & "|" & OpenType & "|" & SpecialID & "|" & UrlType & "|" & ShowPropertyType & "|" & Author & "|" & Cols & "|" & CssNameA & "|" & CssName1 & "|" & CssName2
    ...
    rsJs.Close
    Set rsJs = Nothing
    Call WriteSuccessMsg("保存JS文件设置属性成功！", "Admin_ArticleJS.asp?ChannelID=" & ChannelID)
    Call CreateJS(ID)
End Sub

Sub SaveJS_Pic()
    Dim ID, JsName, JsReadme, JsFileName, Config
    Dim ClassID, SpecialID, IncludeChild, ArticleNum, IsHot, IsElite, DateNum, OrderType, ShowType, ImgWidth, ImgHeight, TitleLen, ContentLen, ShowTips, Cols, UrlType
    Dim rsJs, sqlJs, trs
    Dim ContentType
    ...
    Config = ClassID & "|" & IncludeChild & "|" & ArticleNum & "|" & IsHot & "|" & IsElite & "|" & DateNum & "|" & OrderType & "|" & ShowType & "|" & ImgWidth & "|" & ImgHeight & "|" & TitleLen & "|" & ContentLen & "|" & ShowTips & "|" & Cols & "|" & SpecialID & "|" & UrlType
    ...
    rsJs.Close
    Set rsJs = Nothing
    Call WriteSuccessMsg("保存JS文件设置成功！", "Admin_ArticleJS.asp?ChannelID=" & ChannelID)
    Call CreateJS(ID)
End Sub
%>
