...
Sub Add()
    Response.Write "<form action='Admin_SoftJS.asp' method='post' name='myform' id='myform'>"
    ...
    Response.Write "      <td height='25'><input name='SoftNum' type='text' value='10' size='5' maxlength='3'> <font color='#FF0000'>*</font></td>"
    Response.Write "    </tr>"
    Response.Write "    <tr class='tdbg'>"
    ...
    Response.Write "          <td><input name='ShowAuthor' type='checkbox' id='ShowAuthor' value='1'>作者/开发商</td>"
...
Sub Modify()
    ...
    Response.Write "    <tr class='tdbg'>"
    Response.Write "      <td height='25' align='right'><strong>" & ChannelShortName & "数目：</strong></td>"
    Response.Write "      <td height='25'><input name='SoftNum' type='text' value='" & JsConfig(1) & "' size='5' maxlength='3'> <font color='#FF0000'>*</font></td>"
    Response.Write "    </tr>"
    Response.Write "    <tr class='tdbg'>"
    Response.Write "      <td height='25' align='right'><strong>所属栏目：</strong></td>"
    Response.Write "      <td height='25'>"
    ...
    Response.Write "          <td><input name='ShowAuthor' type='checkbox' id='ShowAuthor' " & RadioValue(PE_CLng(JsConfig(11)), 1) & ">作者/开发商</td>"
    Response.Write "          <td>更新时间"
    Response.Write "            <select name='ShowDateType' id='ShowDateType'>"
...
Sub AddPic()
    ...
    Response.Write "    <tr class='tdbg'>"
    Response.Write "      <td height='25' align='right'><strong>" & ChannelShortName & "数目：</strong></td>"
    Response.Write "      <td height='25'><input name='SoftNum' type='text' value='4' size='5' maxlength='3'> <font color='#FF0000'>*</font></td>"
    Response.Write "    </tr>"
    Response.Write "    <tr class='tdbg'>"
    Response.Write "      <td height='25' align='right'><strong>" & ChannelShortName & "属性：</strong></td>"
    Response.Write "      <td height='25'>"
...
Sub ModifyPic()
    ...
    Response.Write "    <tr class='tdbg'>"
    Response.Write "      <td height='25' align='right'><strong>" & ChannelShortName & "数目：</strong></td>"
    Response.Write "      <td height='25'><input name='SoftNum' type='text' value='" & JsConfig(2) & "' size='5' maxlength='3'> <font color='#FF0000'>*</font></td>"
    Response.Write "    </tr>"
    Response.Write "    <tr class='tdbg'>"
    Response.Write "      <td height='25' align='right'><strong>" & ChannelShortName & "属性：</strong></td>"
    Response.Write "      <td height='25'>"
...
Sub SaveJS_List()
    ...
    Dim ShowType, SoftNum, ClassID, SpecialID, IncludeChild, IsHot, IsElite, DateNum, OrderType, TitleLen, ContentLen
    ...
    SoftNum = PE_CLng(Trim(Request("SoftNum")))
    ...
    Config = ShowType & "|" & SoftNum & "|" & ClassID & "|" & IncludeChild & "|" & IsHot & "|" & IsElite & "|" & DateNum & "|" & OrderType & "|" & TitleLen & "|" & ContentLen & "|" & ShowClassName & "|" & ShowAuthor & "|" & ShowDateType & "|" & ShowHits & "|" & ShowHotSign & "|" & ShowNewSign & "|" & ShowTips & "|" & OpenType & "|" & UrlType & "|" & ShowPropertyType & "|" & SpecialID & "|" & Author & "|" & Cols & "|" & CssNameA & "|" & CssName1 & "|" & CssName2
    ...
    Call WriteSuccessMsg("保存JS文件设置成功！", "Admin_SoftJS.asp?ChannelID=" & ChannelID)
    Call CreateJS(ID)
End Sub

Sub SaveJS_Pic()
    Dim ID, JsName, JsReadme, JsFileName, Config
    Dim ClassID, SpecialID, IncludeChild, SoftNum, IsHot, IsElite, DateNum, OrderType, ShowType, ImgWidth, ImgHeight, TitleLen, ContentLen, ShowTips, Cols, UrlType
    Dim rsJs, sqlJs, trs
    Dim ContentType
    ...
    Config = ClassID & "|" & IncludeChild & "|" & SoftNum & "|" & IsHot & "|" & IsElite & "|" & DateNum & "|" & OrderType & "|" & ShowType & "|" & ImgWidth & "|" & ImgHeight & "|" & TitleLen & "|" & ContentLen & "|" & ShowTips & "|" & Cols & "|" & UrlType & "|" & SpecialID
