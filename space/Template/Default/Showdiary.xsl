    ...
    <tr>
      ...
      <!--用户登录代码结束-->
        <table cellSpacing="0" cellPadding="0" width="100%" border="0">
          ...
          <tbody id="plopti">
          <tr>
            <td class="left_tdbg1" align="middle"><a href="Showdiary.asp?BlogID={body/MyBlog/BlogID}">= 全部日志 =</a><br /><a href="{body/MyBlog/BlogDir}/">= 返回首页 =</a><br /><a href="index.asp">= 空间列表 =</a></td>
          </tr>
          </tbody>
          <tr>
        ...
        <table cellSpacing="0" cellPadding="0" width="100%" border="0">
          <tr onclick="new Element.toggle('plinfo')">
            <td class="left_title" align="middle">日 志 公 告</td>
          </tr>
          <tbody id="plinfo">
          <tr>
