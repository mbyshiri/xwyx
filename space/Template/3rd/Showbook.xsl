...
<div id="showpage">载入分页信息...</div>
      ...
      <!--用户登录代码结束-->
        <table cellSpacing="0" cellPadding="0" width="100%" border="0">
          ...
          <tbody id="plopti">
          <tr>
            <td class="left_tdbg1" align="middle"><a href="Showbook.asp?BlogID={body/MyBlog/BlogID}">= 全部图书 =</a><br /><a href="{body/MyBlog/BlogDir}/">= 返回首页 =</a><br /><a href="index.asp">= 空间列表 =</a></td>
          </tr>
          </tbody>
          <tr>
