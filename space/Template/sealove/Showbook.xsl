...
{
    var saveurl = "Showbook.asp?Action=savepl";
    var name = $F('plname');
    var noname = $F('noname');
    var plpass = $F('plpass');
    var title = $F('pltitle');
        ...
        if((noname!='1')&(plpass=='')&&(userstat=='login')){
            ...
            if(title==''){
                ...
                if(content==''){
                    ...
                    // 创建返回信息XML文档
                    var checkurl = "Showbook.asp?Action=savepl";
...
<div id="showpage">载入分页信息...</div>
	...
	<td width="180" valign="top">
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			<tr><td width="1" bgcolor="#AAAAAA"></td>
				...
				<table width="96%" align="center" border="0" cellpadding="0" cellspacing="0">
					<tr><td align="center"><a href="Showbook.asp?BlogID={body/MyBlog/BlogID}">= 全部图书 =</a><br /><a href="{body/MyBlog/BlogDir}/">= 返回首页 =</a><br /><a href="index.asp">= 空间列表 =</a></td></tr>
				</table>
				</td>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			<tr><td width="33" height="28"><img src="../Skin/sealove/Column01_L.gif" /></td>
				<td background="../Skin/sealove/Column01_BG.gif" style="color:#FFFFFF"><b>广 而 告 之</b></td>
				<td width="10"><img src="../Skin/sealove/Column01_R.gif" /></td></tr>
		</table>
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			<tr><td width="1" bgcolor="#AAAAAA"></td>
