...
<TR><TD width="220"><fieldset><legend><b>查找 / 替换设置</b></legend>
...
<TR>
  <TD VALIGN="top" align="left" nowrap><input type=Checkbox size=40 name=blnMatchCase id="blnMatchCase">
    <label for="blnMatchCase">区分大小写</label>
