<!--#include file="User_ConsumeLog_Code.asp"-->
<%
If ShowUserModel = False Then
%>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=gb2312" />
<title><%=SiteName & " >> 会员中心" & PointName & "明细查询" %></title>
      ...
      <table width="100%" border="0" cellpadding="5" cellspacing="0" class="user_box">
        <tr>
          <td class="user_righttitle"><img src="Images/point2.gif" align="absmiddle">
            <%
            Response.Write "您现在的位置：<a href='../'>" & SiteName & "</a> >> <a href='Index.asp'>会员中心</a> >> " & PointName & "明细查询 >> "
        ...
        <tr>
          <td height="200" valign='top'>
            <br><p align='center'>
            <a href='User_ConsumeLog.asp'><img src='images/detail_all.jpg' border='0' title='所有明细记录'></a>&nbsp;&nbsp;&nbsp;&nbsp;
            <a href='User_ConsumeLog.asp?ShowType=1'><img src='images/detail_income.jpg' border='0' title='所有收入记录'></a>&nbsp;&nbsp;&nbsp;&nbsp;
            <a href='User_ConsumeLog.asp?ShowType=2'><img src='images/detail_payout.jpg' border='0' title='所有支出记录'></a>
            </p>
			<%Call Main()%>
          </td>
        </tr>
...
Else
    ...
    strPageTitle = "您现在的位置：<a href='../'>" & SiteName & "</a> >> <a href='Index.asp'>会员中心</a> >> "& PointName &"明细查询 >> "
    Select Case ShowType
    Case 0
