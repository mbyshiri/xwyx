<!--#include file="User_SpaceMusic_Code.asp"-->
<%
If ShowUserModel = False Then
%>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=gb2312" />
<title><%=SiteName%> >> 会员中心 >> 我的音乐管理</title>
  ...
  <tr>
    <td valign="top">
      <table width="100%" border="0" cellpadding="5" cellspacing="0" class="user_box">
        <tr>
          <td class="user_righttitle"><img src="Images/point2.gif" align="absmiddle"><%="您现在的位置：<a href='../'>" & SiteName & "</a> >> <a href='Index.asp'>会员中心</a> >> 我的音乐管理"%></td>
        </tr>
        <tr>
...
Else
    ...
    PageTitle = SiteName & " >> 会员中心 >> 我的音乐管理"
    strPageTitle = "您现在的位置：<a href='../'>" & SiteName & "</a> >> <a href='Index.asp'>会员中心</a> >> 我的音乐管理"
