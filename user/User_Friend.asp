<!--#include file="User_Friend_Code.asp"-->
<%
...
Response.Write "您现在的位置：<a href='../'>" & SiteName & "</a> >> <a href='Index.asp'>会员中心</a> >> 我的好友管理"
          %></td>
        </tr>
        <tr>
...
Else
    ...
    strPageTitle = "您现在的位置：<a href='../'>" & SiteName & "</a> >> <a href='Index.asp'>会员中心</a> >> 我的好友管理"
